...
CAT_TEXT = "#cdd6f4"
CAT_SUBTEXT0 = "#a6adc8"
CAT_GREEN = "#a6e3a1"  # Accent
CAT_RED = "#f38ba8"
CAT_OVERLAY0 = "#6c7086"
CAT_LAVENDER = "#b4befe"

# Export specific colors if needed in python code (e.g. for ClickableLabel)
CAT_COLORS = {
    "BASE": CAT_BASE,
    "MANTLE": CAT_MANTLE,
    "SURFACE0": CAT_SURFACE0,
    "SURFACE1": CAT_SURFACE1,
    "TEXT": CAT_TEXT,
    "GREEN": CAT_GREEN,
    "RED": CAT_RED
}
...
def get_stylesheet():
    ...
    return f"""
        ...
        QLineEdit, QTextEdit, QListWidget {{ 
            ...
            padding: 6px; 
            color: {CAT_TEXT}; 
            selection-background-color: {CAT_GREEN}; 
            selection-color: {CAT_BASE};
        }}
        ...
        QSpinBox::up-button, QDoubleSpinBox::up-button {{
            ...
            width: 16px; 
            border-left: 1px solid {CAT_SURFACE1};
        ...
        QSpinBox::up-arrow, QDoubleSpinBox::up-arrow {{
            ...
            border-bottom: 3px solid {CAT_TEXT};
        }}
        QSpinBox::down-arrow, QDoubleSpinBox::down-arrow {{
            width: 0; height: 0;
            border-left: 3px solid transparent;
            border-right: 3px solid transparent;
            border-top: 3px solid {CAT_TEXT};
        }}
